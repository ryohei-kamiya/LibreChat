...
import ExportMindMapModal from './ExportMindMapModal';
import { useLocalize } from '~/hooks';
import { cn } from '~/utils/';
import store from '~/store';

const ExportMindMapConversation = forwardRef(() => {
  ...
  return (
    <>
      ...
      <ExportMindMapModal open={open} onOpenChange={setOpen} />
    </>
  );
});

export default ExportMindMapConversation;
