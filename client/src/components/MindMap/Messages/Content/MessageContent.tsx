...
import Plugin from '~/components/MindMapMessages/Content/Plugin';
import Error from '~/components/MindMapMessages/Content/Error';
...
const ErrorMessage = ({ id, paramId, nodeId, text }: TText) => {
...
const MessageContent = ({
  ...
  if (error) {
    return <ErrorMessage id={props.id} paramId={props.paramId} nodeId={props.nodeId} text={text} />;
  } else if (edit) {
    return (
      <EditMessage
        id={props.id}
