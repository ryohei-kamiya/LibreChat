...
import { EndpointSettings, SaveAsPresetDialog } from '~/components/MindMapEndpoints';
import { ModelSelect } from '~/components/MindMapInput/ModelSelect';
import { PluginStoreDialog } from '~/components';
import OptionsPopover from './OptionsPopover';
import PopoverButtons from './PopoverButtons';
import { useMindMapSetIndexOptions, useMindMapHelpers, useMindMapNodeHandler } from '~/hooks';
...
export default function OptionsBar({
  ...
  const altConditions: { [key: string]: boolean } = {
    bingAI: !!(latestMindMapMessage && mindMapConversation?.jailbreak && endpoint === 'bingAI'),
  };
