...
import PopoverButtons from '~/components/MindMap/Input/PopoverButtons';
import DialogTemplate from '~/components/ui/DialogTemplate';
import { useMindMapSetIndexOptions, useLocalize, useMindMapNodeHandler } from '~/hooks';
import { EndpointSettings } from '~/components/MindMapEndpoints';
