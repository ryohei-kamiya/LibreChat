...
import { cleanupMindMapPreset } from '~/utils';
import store from '~/store';

type TUsePresetOptions = (preset?: TPreset | boolean | null) => TSetOptionsPayload | boolean;

const useMindMapPresetOptions: TUsePresetOptions = (_preset) => {
...
export default useMindMapPresetOptions;
